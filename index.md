...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Recursos**
  ...
  20        | 23.03.2023   | Métricas para algoritmos de agrupamiento. <br/> [Aula 17](aulas/Aula17.pdf){:target="_blank"} |  
...
<div id='id-labs'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Material**
  ...
  16       | 21.03.2023   | Ejemplo de métodos basados en densidad: Mean-Shift, DBSCAN, OPTICS, BIRCH. | [aula15.ipynb](scripts/density-based.ipynb){:target="_blank"} [comparison.ipynb](scripts/comparison.ipynb){:target="_blank"} 
